/*VARIABLES*/
var trailhead = {lat: 37.2271022, lng: -113.4022991};
...
var main = function() {
    ...
    $('.forecast-btn').click(function(){
      ...
      //query OpenWeatherMap by geolocation
      var url = "http://api.openweathermap.org/data/2.5/forecast/daily?lat=37.203467&lon=-113.641&APPID=1088269cadd02d84dba9b274fc7bc097&mode=html&units=imperial&cnt=7";
...
function initMap() {
  ...
  var marker = new google.maps.Marker({
    ...
    map: map,
    title: 'Trail Head',
    url: 'https://maps.google.com/maps?layer=c&panoid=F:-18cfzszfsxQ/VrONwwILwSI/AAAAAAAABXg/DcQEMaI_jrI&ie=UTF8&source=embed&output=svembed&cbp=13%2C6%2C%2C0%2C-6.6'
  });
  ...
  var ctaLayer = new google.maps.KmlLayer({
    url: 'http://chiseloutdoors.com/beta/trails/json_layers/KML-csv_20160208012820.kml',
    map: map
  });
